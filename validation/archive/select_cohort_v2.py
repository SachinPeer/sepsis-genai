"""
Phase 1 v2: Select validation cohort with TREND DATA.
Instead of single snapshots, passes 6 hours of trending vitals + rich nurse notes.
"""
...
def main():
    print("=" * 60)
    print("Phase 1 v2: Select Cohort with TREND DATA")
    print("=" * 60)
    ...
    with open(manifest_path, "w") as f:
        json.dump({
            ...
            "version": "v2 - with 6-hour trend data",
